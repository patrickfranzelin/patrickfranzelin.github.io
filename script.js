...
async function initializeViewer() {
  try {
    ...
    imageryLayer2.alpha = 0.3;  // Adjust transparency (0 is fully transparent, 1 is fully opaque)
    imageryLayer2.colorToAlpha = Cesium.Color.RED.withAlpha(0.3);  // Apply light red tint
